...
foreach ($json as $key => $value) {
    echo "<div class='produto n".$key."'>";
    echo "<img class='imgproduto' src=".$json[$key]["imagem"].">";
    echo "<br>";
    echo "<div class='precoimg'>";
    echo '<img class="imgpreco" src="https://media.discordapp.net/attachments/910216507085168670/910567356340772885/unknown.png?width=28&height=28">'.'<p class="preco">'.$json[$key]["preço"].'<p>'."<br>";echo "</div>";
    echo '<p class="nomeproduto">'.$json[$key]["nome"].'</p>';
    echo "<a style='padding-right:20px;' href='controllers/addCarrinho.php?product=".$key."'>".$produtobutton."</a>";
    echo "</div>";
}
